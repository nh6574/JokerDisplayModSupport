...
if not SMODS.Mods["JankJonklersMod"] then
    return
end

local jd_def = JokerDisplay.Definitions

jd_def["j_fortuno"] = { -- Fortuno
    text = {
        { text = "+$" },
...
jd_def["j_jevil"] = { -- Jevil

}
jd_def["j_midnight_crew"] = { -- Midnight Crew
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_devilish"] = { -- Devilish Joker
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_impractical"] = { -- Impractical Joker
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_wanted_poster"] = { -- Wanted Poster
    text = {
        { ref_table = "card.joker_display_values", ref_value = "dollars" }
    },
    text_config = { colour = G.C.GOLD },
...
jd_def["j_makeshift"] = { -- Makeshift Joker
    text = {
        { text = '+' },
...
jd_def["j_pitiful"] = { -- Pitiful Joker
    text = {
        { text = "+" },
        { ref_table = "card.joker_display_values", ref_value = "mult" }
    },
...
jd_def["j_ternary_system"] = { -- Ternary System
    reminder_text = {
        { text = '(' },
        { ref_table = "card.joker_display_values", ref_value = "active_text" },
        { text = ')' },
...
jd_def["j_minimalist"] = { -- Minimalist Joker
    text = {
        { text = "+" },
        { ref_table = "card.joker_display_values", ref_value = "mult" }
    },
...
jd_def["j_devoted"] = { -- Devoted Joker
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_scrapper"] = { -- Scrapper Joker
    text = {
        { text = '+' },
...
jd_def["j_old_man"] = { -- Old Man Joker

}
jd_def["j_box_of_stuff"] = { -- Box of Stuff

}
jd_def["j_expanded_art"] = { -- Expanded Art Joker
    text = {
        { text = "+" },
...
jd_def["j_highlander"] = { -- Highlander Joker

}
jd_def["j_lieutenant"] = { -- Lieutenant Joker

}
jd_def["j_cut_the_cheese"] = { -- Cut the Cheese

}
jd_def["j_shady_dealer"] = { -- Shady Dealer

}
jd_def["j_suspicious_vase"] = { -- Suspicious Vase
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_mural_menace"] = { -- Mural Menace

}
jd_def["j_chicken_scratch"] = { -- Chicken Scratch
    text = {
        { text = '+' },
...
jd_def["j_chalk_outline"] = { -- Chalk Outline
    text = {
        { text = '+' },
...
jd_def["j_boredom_slayer"] = { -- Boredom Slayer

}
jd_def["j_cardslinger"] = { -- Cardslinger
    text = {
        { text = '+' },
        { ref_table = "card.joker_display_values", ref_value = "chips" }
    },
...
jd_def["j_sunday_funnies"] = { -- Sunday Funnies
    reminder_text = {
        { text = '(' },
...
jd_def["j_self_portrait"] = { -- Self Portrait
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_memorable"] = { -- Memorable Joker
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_tapestry"] = { -- Tapestry Joker
    text = {
        { text = '+' },
        { ref_table = "card.ability.extra", ref_value = "mult" }
    },
