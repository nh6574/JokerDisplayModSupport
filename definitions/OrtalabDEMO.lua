...
if not SMODS.Mods["OrtalabDEMO"] then
    return
end

local jd_def = JokerDisplay.Definitions

jd_def["j_jester"] = { -- Jester
    text = {
        { text = "+" },
...
jd_def["j_generous_joker"] = { -- Generous Joker
    text = {
        { text = "+" },
...
jd_def["j_chastful_joker"] = { -- Chastful Joker
    text = {
        { text = "+" },
        { ref_table = "card.joker_display_values", ref_value = "chips" }
    },
...
jd_def["j_patient_joker"] = { -- Patient Joker
    text = {
        { text = "+" },
        { ref_table = "card.joker_display_values", ref_value = "chips" }
    },
...
jd_def["j_abstemious_joker"] = { -- Abstemious Joker
    text = {
        { text = "+" },
        { ref_table = "card.joker_display_values", ref_value = "chips" }
    },
...
jd_def["j_the_mysterium"] = { -- The Mysterium
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_the_spectrum"] = { -- The Spectrum
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_popcorn_bag"] = { -- Popcorn Bag
    text = {
        { text = "+" },
...
jd_def["j_collatz"] = { -- Collatz Conjecture
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_triangle_joker"] = { -- Triangle Joker
    text = {
        { text = "+" },
...
jd_def["j_croupier"] = { -- Croupier

}
jd_def["j_chameleon_joker"] = { -- Chameleon Joker
...
jd_def["j_taliaferro"] = { -- Taliaferro
    text = {
        { text = "+" },
        { ref_table = "card.ability.extra", ref_value = "chips" }
    },
...
jd_def["j_royal_gala"] = { -- Royal Gala
    text = {
        { text = "+" },
        { ref_table = "card.ability.extra", ref_value = "chips" }
    },
...
jd_def["j_sedimentation"] = { -- Sedimentation
    text = {
        { text = "+" },
...
jd_def["j_inverse_midas"] = { -- Beyond The Mask
    text = {
        { text = "+$" },
...
jd_def["j_fuel_tank"] = { -- Afterburner
    text = {
        { text = "+$" },
...
jd_def["j_mint_condition"] = { -- Mint Condition
...
jd_def["j_frowny_face"] = { -- Frowny Face
    text = {
        { text = "+" },
        { ref_table = "card.joker_display_values", ref_value = "mult" }
    },
...
jd_def["j_scared_face"] = { -- Scared Face
    text = {
        { text = "+" },
        { ref_table = "card.joker_display_values", ref_value = "chips" }
    },
...
jd_def["j_mystery_soda"] = { -- Mystery Soda
...
jd_def["j_slot_machine"] = { -- Slot Machine
    text = {
        { text = '+' },
...
jd_def["j_roscharch_test"] = { -- Roscharch Test
    text = {
        { ref_table = "card.joker_display_values", ref_value = "count" },
        { text = "x",                              scale = 0.35 },
...
jd_def["j_woo_all_1s"] = { -- Woo! All 1s

}
jd_def["j_crime_scene"] = { -- Crime Scene

}
jd_def["j_occultist"] = { -- Occultist

}
jd_def["j_shrine"] = { -- Shrine
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_monochrome"] = { -- Monochrome
    reminder_text = {
        { text = "(" },
        { ref_table = "card.joker_display_values", ref_value = "localized_text" },
        { text = ")" },
...
jd_def["j_proletaire"] = { -- Prolétaire
    text = {
        { text = "+$" },
        { ref_table = "card.joker_display_values", ref_value = "dollars" },
    },
...
jd_def["j_art_gallery"] = { -- Art Gallery
    text = {
        { text = "+" },
        { ref_table = "card.joker_display_values", ref_value = "chips" }
    },
...
jd_def["j_instant_gratification"] = { -- Instant Gratification

}
jd_def["j_coupon"] = { -- Coupon
    text = {
        { text = "-" },
...
jd_def["j_mathmagician"] = { -- Mathmagician
    text = {
        { text = "+" },
        { ref_table = "card.joker_display_values", ref_value = "count" },
    },
